    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Vault.route) {
                VaultScreen(onNavigateUp = navController::navigateUp)
            }

            composable(Screen.Cleaner.route) {
                CleanerScreen(onNavigateUp = navController::navigateUp)
            }
            ...
            composable(Screen.Trash.route) {
                TrashScreen(onNavigateUp = navController::navigateUp)
            }
            ...
            composable(Screen.Collage.route) {
                CollageScreen(onNavigateUp = navController::navigateUp)
            }
            ...
            composable(Screen.AppLock.route) {
                AppLockScreen(onNavigateUp = navController::navigateUp)
            }
        }
    }
}
